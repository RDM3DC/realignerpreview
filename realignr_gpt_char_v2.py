# realignr_gpt_char_pro.py — RealignR + GPT-CoPilot + CPR + logging + extended dataset
...
for epoch in range(EPOCHS):
    for xb, yb in dataloader:
        ...
        if step % LOG_INTERVAL == 0:
            ...
            # --- CPR if slope flatlines ---
            if prev_loss and abs(prev_loss - loss.item()) < CPR_THRESHOLD and g_mean < 0.05:
                print("💥 CPR EVENT: Resetting G (flatline detected)")
                model.G.mul_(0.2)
