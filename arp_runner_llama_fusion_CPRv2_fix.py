...
def train_worker(rank, world_size, alpha, mu, dataset="CIFAR10", weight_decay=1e-4, max_epochs=30, spike_threshold=1.5, instability_std=0.2, switch_min_epoch=23, batch_size=128, lr=1e-3):
    ...
    for epoch in range(max_epochs):
        ...
        if rank == 0:
            ...
            # --- Mid-run ARP CPR Protocol v2 (rank-0 guarded) ---
            if rank == 0 and switched and epoch in [46, 60] and accuracy < 10.0:
    ...
    # --- Optional ARP Memory Reset / Reboot ---
            if switched and epoch == 46:  # Adjusted to trigger at epoch 46
